...
const createExpansionGroups = () => {
    ...
    const season9 = [wusets["Breakneck Slaughter Rivals Deck"].id, wusets["Force of Frost Rivals Deck"].id, wusets["Malevolent Masks Rivals Deck"].id, wusets["Rimelocked Relics Rivals Deck"].id];
