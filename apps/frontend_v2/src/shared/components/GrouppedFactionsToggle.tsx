...
type FactionId = (typeof sortedFactions)[number]["id"];

interface GrouppedFactionsToggleProps {
  selectedFactions: FactionId[];
  onSelectionChanged: (selected: FactionId[]) => void;
  allowMultiSelect?: boolean;
}

const grouppedFactions = () => {
  return [{ title: "All", factions: sortedFactions }];
};

const GrouppedFactionsToggle = ({
  selectedFactions,
  onSelectionChanged,
