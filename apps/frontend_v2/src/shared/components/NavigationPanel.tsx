...
function AnimatedLink(props: React.ComponentPropsWithoutRef<typeof Link> & { container?: string }) {
...
const Menu = ({ classes, showHome, children }: { classes: string; showHome?: boolean; children?: React.ReactNode }) => {
    useAuthUser();
