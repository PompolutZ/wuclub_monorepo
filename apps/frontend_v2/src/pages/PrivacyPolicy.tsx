    ...
    return (
      <div className="space-y-4 mx-auto my-4 max-w-3xl">
        ...
        <p>
          ...
          WUNDERWORLDS-CLUB is managed through{" "}
        ...
        <p>
          ...
          our Terms and Conditions, accessible from https://wunderworlds.club/
        </p>
        ...
        <p>
          In order to delete all data stored by us you need to make a request
          either by contacting author and maintainer of this website by email:{" "}
          <a
            className="text-purple-900 font-bold"
            href="mailto:pompolutz@gmail.com"
          >
            pompolutz@gmail.com
          </a>
          or by contacting user fxdxpz on Discord's channel: Warhammer
          Underworlds Vassal.
        </p>
        ...
        <ul>
          <li className="">
            ...
            >
              https://wunderworlds.club/privacy-policy
            </a>
          </li>
        </ul>
      </div>
