...
function DetailedPlayStyleValidity({ cards, className = "" }: { cards: CardId[]; className?: string }) {
    ...
    const [relicValid] = validateDeckForPlayFormat(cardsByType, RELIC_FORMAT as never);
