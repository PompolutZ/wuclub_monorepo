...
export const DeckSVG = ({ style }: { style?: React.CSSProperties }) => (
    <svg
        width="40"
        height="31"
        viewBox="0 0 40 31"
...
export const AddCardSVG = ({ style }: { style?: React.CSSProperties }) => (
    <svg
        version="1.1"
        id="Layer_1"
        x="0px"
...
export const RestrictedCardSVG = ({ style }: { style?: React.CSSProperties }) => (
    <svg
...
export const Ranking = ({ style }: { style?: React.CSSProperties }) => (
    <svg
        version="1.1"
        id="Layer_1"
        xmlns="http://www.w3.org/2000/svg"
