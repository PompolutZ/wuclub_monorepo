...
export const pickCardColor2 = (id: CardId | string, format: string) => {
    const [, isForsaken, isRestricted] = validateCardForPlayFormat(id as CardId, format as never);
...
export const pickCardBackgroundColor2 = (id: CardId | string, format: string) => {
    const [, isForsaken, isRestricted] = validateCardForPlayFormat(id as CardId, format as never);
